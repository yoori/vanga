...
#ifndef GEARS_BOOLFUNCTORS_HPP
#define GEARS_BOOLFUNCTORS_HPP
...
namespace Gears
{
  ...
  template <typename Predicate1>
  class True1:
    public std::unary_function<typename Predicate1::argument_type, bool>,
  ...
  class True2:
    public std::binary_function<
      typename Predicate1::first_argument_type,
  ...
  class Conditional1:
    public std::unary_function<typename Predicate1::argument_type, bool>,
    protected BoolFunctorsHelper::PredicatesHolder3<
  ...
  class Conditional2:
    public std::binary_function<
      ...
      typename Predicate1::second_argument_type,
      bool>,
    protected BoolFunctorsHelper::PredicatesHolder3<Predicate1, Predicate2, Predicate3>
  {
  public:
    /**
     * Constructor
