...
#ifndef GEARS_DIRSELECTOR_HPP
#define GEARS_DIRSELECTOR_HPP
...
namespace Gears
{
  ...
  namespace DirSelect
  {
    ...
    DECLARE_GEARS_EXCEPTION(FailedToOpenDirectory, Exception);
    DECLARE_GEARS_EXCEPTION(FailedToStatFile, Exception);
  ...
  namespace DirSelect
  {
    ...
    namespace DirectoryFilterHelper
    {
        ...
        ErrorHandler failed_to_stat_file) throw (Gears::Exception)
      {
        ...
        std::unique_ptr<char[]> full_path(new char[path_len + NAME_MAX + 2]);
        if (path_len)
        {
